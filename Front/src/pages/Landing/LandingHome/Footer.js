...
import Googlelogo from './images/Google_for_Startups_logo.jpg';
import KAFAlogo from './images/kafa_intro.jpg';
        ...
        <footer className="footer">
            <div className="menu2">
                ...
                <div className="docsButton2">
                    <div className="docs2" onClick={() => window.open('https://stech-2.gitbook.io/stech-docs', '_blank')} style={{ cursor: 'pointer' }}>
                        Docs
                    </div>
                </div>
            ...
            <div className="footer-socials">
                <a href="https://www.instagram.com/stechpro.ai/" target="_blank" rel="noopener noreferrer">
                    <img src={insta} alt="insta" style={{ height: '45px' }} />
                </a>
                <a href="https://www.linkedin.com/company/stechpro/" target="_blank" rel="noopener noreferrer">
                ...
                <img src={Googlelogo} alt="Google" style={{ height: '42.5px' }} />
                <img src={KAFAlogo} alt="KAFA" style={{ height: '42.5px' }} />
            </div>
