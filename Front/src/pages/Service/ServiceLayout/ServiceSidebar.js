        ...
        return (
            <li key={item.path} className="navItem" onMouseEnter={() => setHoveredItem(item.path)} onMouseLeave={() => setHoveredItem(null)}>
                ...
                >
                    ...
                    {location.pathname === item.path && <div className="activeIndicator" />}
                    {hoveredItem === item.path && (
                        <div className="navTooltip">
                            <span>{item.description}</span>
                        </div>
    ...
    return (
        <aside className="sidebar">
            ...
            <div className="sidebarHeader">
                <div className="logo">
                    <img className="stechLogo" src={Logo} alt="STECH Logo" onClick={() => navigate('/service')} />
                </div>

                <div className="authSection">
                    {isAuthenticated ? (
                        <button onClick={handleLogout} className={`logoutButton ${isLoading ? 'loading' : ''}`} disabled={isLoading}>
                            <div className="logoutIcon">{isLoading ? <div className="spinner" /> : <CiLogout />}</div>
                            <span className="logoutText">{isLoading ? 'Logging out...' : 'Logout'}</span>
                        </button>
                    ) : (
